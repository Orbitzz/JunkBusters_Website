...
CITY_URL_MAP = {
    ...
    'Mt. Juliet, TN': '/junk-removal-lebanon-tn/',
...
CITY_PAGES = {
    ...
    'franklin-ky': {
        ...
        'city_name': 'Franklin, KY',
        'region_name': 'Simpson County',
        'meta_title': 'Junk Removal Franklin KY | Junk Busters LLC',
        'meta_desc': 'Junk Busters LLC serves Franklin, KY with junk removal, estate cleanouts, garage cleanouts & more. Simpson County specialists. Call 615-881-2505.',
        'meta_keywords': 'junk removal Franklin KY, estate cleanout Franklin Kentucky, junk hauling Simpson County KY, garage cleanout Franklin KY, southern Kentucky junk removal',
        'hero_h1': 'Junk Removal & Cleanout Services in Franklin, KY',
        'hero_sub': 'Serving Franklin, Simpson County & the Kentucky-Tennessee border region. Upfront pricing, fully insured. Call 615-881-2505.',
        'area_served': 'Franklin KY, Simpson County KY, Southern Kentucky',
        'intro': [
            'Junk Busters LLC serves Franklin, KY and all of Simpson County with dependable junk removal and cleanout services. Sitting right on the Kentucky-Tennessee state line, Franklin is a natural extension of our Middle TN service area — and we make regular runs through the region.',
            'Our crew handles estate cleanouts, garage haul-aways, appliance removal, and full property clearances with upfront flat-rate pricing. We bring the same professional service to Franklin that our Middle TN customers count on.',
        ],
        'services': [
            {'name': 'Junk Removal', 'desc': 'Full-service haul-away for Franklin homes, farms, and businesses.', 'slug': 'junk-removal'},
            {'name': 'Estate Clean-Out', 'desc': 'Compassionate estate clearing for Simpson County families and real estate agents.', 'slug': 'estate-clean-out'},
            {'name': 'Garage Clean-Out', 'desc': 'Reclaim your Franklin garage or outbuilding — we haul everything away.', 'slug': 'garage-clean-out'},
            {'name': 'Eviction Clean-Out', 'desc': 'Fast eviction trash-outs for Franklin KY landlords and property managers.', 'slug': 'eviction-clean-out'},
            {'name': 'Hot Tub Removal', 'desc': 'Safe hot tub and spa removal in Franklin and Simpson County.', 'slug': 'hot-tub-removal'},
            {'name': 'Foreclosure Clean-Out', 'desc': 'Get Franklin KY REO properties market-ready fast.', 'slug': 'foreclosure-clean-out'},
            {'name': 'Light Demolition', 'desc': 'Shed teardown, fence removal, and deck demo in the Franklin KY area.', 'slug': 'light-demolition'},
